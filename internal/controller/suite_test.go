...
var _ = BeforeSuite(func() {
	...
	var err error
	err = armadaaiv1.AddToScheme(scheme.Scheme)
	...
	// Start the controller manager so that watches (Owns) fire during tests.
	// Metrics and health probe listeners are disabled to avoid port conflicts.
